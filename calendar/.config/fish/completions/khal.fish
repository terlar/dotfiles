...
complete -c khal -n "__khal_using_command configure" -l "help" -d "Show this message and exit."
...
complete -c khal -n "__khal_using_command new" -s "m" -d "Alarm time for the new event."
complete -c khal -n "__khal_using_command new" -l "alarm" -d "Alarm time for the new event."
...
complete -c khal -n "__khal_using_command calendar" -s "w" -d "Include all events in one week."
complete -c khal -n "__khal_using_command calendar" -l "week" -d "Include all events in one week."
...
complete -c khal -n "__khal_using_command agenda" -s "w" -d "Include all events in one week."
complete -c khal -n "__khal_using_command agenda" -l "week" -d "Include all events in one week."
...
complete -c khal -f -n "__khal_no_command" -a configure -d "Helper for initial configuration of khal."
...
complete -c khal -f -n "__khal_no_command" -a new -d "Create a new event from arguments."
