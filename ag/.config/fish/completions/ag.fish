...
complete -c ag -s "L" -d "Only print filenames that don't contain matches"
complete -c ag -l "files-without-matches" -d "Only print filenames that don't contain matches"
...
complete -c ag -s "v" -d "Invert match"
complete -c ag -l "invert-match" -d "Invert match"
